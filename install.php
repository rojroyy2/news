<?php
	...
	function textInfoEnter($link){
		...
		$sol = "strokaDlyaUslogneniyaChecha";
		if(!mysqli_query($link, 'INSERT INTO `admin` (`id`, `surname`, `name`, `patronymic`, `login`, `password`) VALUES (NULL, "Иванов", "Иван", "Иванович", "'.md5(md5("admin". $sol)).'", "'.md5(md5("admin". $sol)).'");')){
